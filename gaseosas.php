...
<body>
    ...
    <section id="promociones">
        ...
        <div class="product-list">
            ...
            <!-- Producto 3 -->
            <div class="product">
                <img src="img/GUARANA.webp" alt="GUARANA">
                <div class="product-info">
                    <h3>GUARANA</h3>
                    <p>Botella 750ml</p>
                    <span class="price-old">s/16.00</span>
                    <span class="price-new">s/15.00</span>
                    <button onclick="addToCart(18, 'GUARANA', 'Botella 750ml', 15.00)">Agregar al carrito</button>
                </div>
            </div>
            <!-- Producto 4 -->
            ...
            <!-- Producto 7 -->
            <div class="product">
                <img src="img/EVERVES.webp" alt="EVERVES">
                <div class="product-info">
                    <h3>EVERVES</h3>
                    <p> Botella 1.5L</p>
                    <span class="price-old">s/10.00</span>
                    <span class="price-new">s/9.00</span>
                    <button onclick="addToCart(19, 'EVERVES', ' Botella 1.5L', 9.00)">Agregar al carrito</button>
                </div>
            </div>
            <!-- Producto 8 -->

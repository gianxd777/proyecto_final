...
<body>
    ...
    <section id="promociones">
        ...
        <div class="product-list">
            <!-- Producto 1 -->
            <div class="product">
                <img src="img/20126204 DURAZNO.webp" alt="CABO BLANCO DURAZNO">
                <div class="product-info">
                    <h3>CABO BLANCO DURAZNO</h3>
                    <p>Botella 750ml</p>
                    <span class="price-old">s/30.00</span>
                    <span class="price-new">s/25.00</span>
                    <button onclick="addToCart(12, 'CABO BLANCO DURAZNO', 'Botella 750ml', 25.00)">Agregar al carrito</button>
                </div>
            </div>
            <!-- Producto 2 -->
            <div class="product">
                <img src="img/20126204 LIMON.webp" alt="CABO BLANCO LIMON">
                <div class="product-info">
                    <h3>CABO BLANCO LIMON</h3>
                    <p>Botella 750ml</p>
                    <span class="price-old">s/35.00</span>
                    <span class="price-new">s/30.00</span>
                    <button onclick="addToCart(13, 'CABO BLANCO LIMON', 'Botella 750ml', 30.00)">Agregar al carrito</button>
                </div>
            </div>
            <!-- Producto 3 -->
            <div class="product">
                <img src="img/20009820 SUPERIOIR.webp" alt="CARTAVIO SUPERIOR ">
                <div class="product-info">
                    <h3>CARTAVIO SUPERIOR</h3>
                    <p>Botella 750ml</p>
                    <span class="price-old">s/35.00</span>
                    <span class="price-new">s/30.00</span>
                    <button onclick="addToCart(14, 'Oso Polar', 'Botella 750ml', 30.00)">Agregar al carrito</button>
                </div>
            </div>
            <!-- Producto 4 -->
            <div class="product">
                <img src="img/1040164002 ROM.webp" alt="CARTAVIO BLACK">
                <div class="product-info">
                    <h3>CARTAVIO BLACK</h3>
                    <p>Botella 750ml</p>
                    <span class="price-old">s/36.00</span>
                    <span class="price-new">s/30.00</span>
                    <button onclick="addToCart(15, 'CARTAVIO BLACK', 'Botella 750ml', 30.00)">Agregar al carrito</button>
                </div>
            </div>
            <!-- Producto 5 -->
